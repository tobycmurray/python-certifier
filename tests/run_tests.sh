...
# Revision models (HIGGS width sweep + EMNIST-byclass). net.txt are generated by
# ../models/regenerate_revision.sh (gitignored, like the originals). No Dafny ref
...
declare -A ALL_INPUTS=(
  ...
  # --- revision (generated by ../models/regenerate_revision.sh; paths relative to tests/) ---
...
run_test() {
  ...
  # (the HIGGS/EMNIST revision models) certify against the computed L_real as the
...
# ref -> L_real baseline). Artifacts come from ../models/regenerate_revision.sh
